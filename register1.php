...
mysql_select_db("gfac") or die(mysql_error());
$query = "INSERT INTO members(name,phoneno, email, address, occupation, nation, birthday, state, lga) VALUES ('$name', '$phoneno', '$email', '$address' ,'$occupation', '$nation, '$birthday', '$state', '$lga')";
